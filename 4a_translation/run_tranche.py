#!/usr/bin/env python3
"""
Experiment 3: Master tranche runner.
...
if __name__ == "__main__":
    ...
    if not args.skip_build:
        ...
        if T == 1:
            run(["build_models.py", "--tranche", str(T), "--conditions", "A,B,C"],
    ...
    print(f"Check Wilson LB and P_hat in report above.")
    print(f"If P_hat >= 0.95 for two consecutive tranches, criterion met.")
